...
Scenario('Should open the page, assert that the descendants first name appears in the Name section, Scroll down until the Guest Book is visible, Leave a Guest Book entry',  ({ I, guestbookPage }) => {
       //Opens the Page
        ...
        //Using the Page object file (guestbookPage) functions to condense the tests above^^^:
          //createGuestBookEntry(message, name, email) --> the function fills the guestbook and submits it:
        guestbookPage.createGuestBookEntry('testing this function to see if this works', 'John Doe', 'jdoe@gmail.com')
});
